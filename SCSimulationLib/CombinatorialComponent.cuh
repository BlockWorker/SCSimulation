...
namespace scsim {
	...
	public:
		...
		CombinatorialComponent(uint32_t num_inputs, uint32_t num_outputs, uint32_t progress_offset, uint32_t type, size_t size, size_t align, StochasticCircuitFactory* factory);
