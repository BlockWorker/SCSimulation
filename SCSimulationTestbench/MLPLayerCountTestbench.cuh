...
/// <summary>
/// Testbench simulating a heavily simplified neural network (multi-layer perceptron) of varying depth, without any useful data. Useful for testing the behaviour of slightly more complex circuits.
/// </summary>
