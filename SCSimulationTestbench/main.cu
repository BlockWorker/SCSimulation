...
void run() {
	...
	//*
	sim_bitwise = true;
	runBench(new InverterTestbench(MIN_SN_LENGTH, 14, 10), "results\\inverter_bitwise.csv");
	runBench(new SquarerTestbench(MIN_SN_LENGTH, 13, 10), "results\\squarer_bitwise.csv");
	//*/
	//*
	sim_bitwise = false;
